...
This repository provides my personal ready-to-use dev environment using [Ansible](https://www.ansible.com) and [GNU Stow](https://www.gnu.org/software/stow/).
...
| **Shell Plugin**    | [zsh-syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting) | 🎨                                                                                                                                                             | Syntax highlighting for Zsh commands             |
| **Shell Plugin**    | [zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions)         | 💡                                                                                                                                                             | Fish-like autosuggestions for Zsh                |
| **Shell Plugin**    | [zsh-completions](https://github.com/zsh-users/zsh-completions)                 | 📝                                                                                                                                                             | Additional completion definitions for Zsh        |
| **Shell Plugin**    | [you-should-use](https://github.com/MichaelAquilina/zsh-you-should-use)         | 💬                                                                                                                                                             | Reminds you to use aliases                       |
| **Shell Plugin**    | [nx-completion](https://github.com/jscutlery/nx-completion)                     | 🔧                                                                                                                                                             | Nx workspace autocompletion                      |
| **Shell Tools**     | [lsd](https://github.com/Peltoche/lsd)                                          | 📂                                                                                                                                                             | Modern `ls` command with colors and icons        |
| **Shell Tools**     | [fzf](https://github.com/junegunn/fzf)                                          | 🔍                                                                                                                                                             | Command-line fuzzy finder                        |
| **Shell Tools**     | [zoxide](https://github.com/ajeetdsouza/zoxide)                                 | 🚀                                                                                                                                                             | Smarter cd command that learns your habits       |
| **Shell Tools**     | [bat](https://github.com/sharkdp/bat)                                           | 🦇                                                                                                                                                             | Cat clone with syntax highlighting               |
| **Shell Tools**     | [ripgrep](https://github.com/BurntSushi/ripgrep)                                | 🔎                                                                                                                                                             | Fast search tool that respects gitignore         |
| **Shell Tools**     | [fd](https://github.com/sharkdp/fd)                                             | 🔦                                                                                                                                                             | Simple, fast alternative to find                 |
...
| **Video Editing**   | [Kdenlive](https://kdenlive.org/)                                               | <img src="https://kdenlive.org/wp-content/uploads/2023/11/kdenlive-logo.svg" width="24" alt="Kdenlive">                                                        | Professional video editing software              |
...
| **Terminal**        | [Warp](https://www.warp.dev/)                                                   | <img src="https://www.warp.dev/favicon.ico" width="24" alt="Warp">                                                                                             | Modern terminal with AI-powered features         |
| **API Client**      | [Bruno](https://www.usebruno.com/)                                              | <img src="https://www.usebruno.com/favicon.ico" width="24" alt="Bruno">                                                                                        | Open-source API client alternative to Postman    |
| **Networking**      | [ngrok](https://ngrok.com/)                                                     | <img src="https://ngrok.com/favicon.ico" width="24" alt="ngrok">                                                                                               | Secure tunnels to localhost                       |
| **Monitoring**      | [New Relic CLI](https://github.com/newrelic/newrelic-cli)                        | <img src="https://newrelic.com/favicon.ico" width="24" alt="New Relic">                                                                                         | New Relic observability CLI                       |
| **AI**              | [ChatGPT Desktop](https://openai.com/chatgpt)                                  | <img src="https://openai.com/favicon.ico" width="24" alt="ChatGPT">                                                                                            | OpenAI ChatGPT desktop application               |
| **Media**           | [VLC](https://www.videolan.org/)                                                | <img src="https://www.videolan.org/favicon.ico" width="24" alt="VLC">                                                                                           | Free and open source multimedia player           |
| **Development**     | [Android Studio](https://developer.android.com/studio)                          | <img src="https://developer.android.com/static/images/favicon.ico" width="24" alt="Android Studio">                                                            | Official Android IDE                              |
| **Testing**         | [autocannon](https://github.com/mcollina/autocannon)                            | 🔫                                                                                                                                                             | HTTP/1.1 benchmarking tool                       |
| **Networking**      | [localtunnel](https://github.com/localtunnel/localtunnel)                        | 🚇                                                                                                                                                             | Expose localhost to the world                     |
| **Load Testing**    | [k6](https://k6.io/)                                                            | <img src="https://k6.io/favicon.ico" width="24" alt="k6">                                                                                                      | Modern load testing tool by Grafana              |
| **AI**              | [Claude Desktop](https://claude.ai/)                                            | <img src="https://www.anthropic.com/images/icons/apple-touch-icon.png" width="24" alt="Claude">                                                                | Anthropic Claude desktop application             |
| **Debugging**       | [HTTP Toolkit](https://httptoolkit.com/)                                        | <img src="https://httptoolkit.com/favicon.ico" width="24" alt="HTTP Toolkit">                                                                                   | HTTP debugging proxy and analyzer                |
| **Virtualization**  | [VirtualBox](https://www.virtualbox.org/)                                       | <img src="https://www.virtualbox.org/favicon.ico" width="24" alt="VirtualBox">                                                                                  | Free and open-source hosted hypervisor           |
| **Dev Tools**       | [cloc](https://github.com/AlDanial/cloc)                                        | 📏                                                                                                                                                             | Count lines of code                              |
| **Dev Tools**       | [inotify-tools](https://github.com/inotify-tools/inotify-tools)                 | 👁️                                                                                                                                                             | File system event monitoring utilities           |
| **Android**         | [adb & fastboot](https://developer.android.com/tools)                            | <img src="https://developer.android.com/static/images/favicon.ico" width="24" alt="Android">                                                                   | Android Debug Bridge and flashing tools          |
